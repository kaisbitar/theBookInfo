<?php
   ...
   // $text = $myfile;//echo $text;
    if(isset($text)){
        ...
        $sura = prepareSuraJSON($fullSura);
        $sura->suraName = $suraName;
        ...
        // $verseWordsObject = pross_verseWords($verseWords);
        ...
        //     $wordsArray = $verse->verse;  

        //     // for($j=0; $j<sizeof($wordsArray); $j++){

        //     //     $words = new words($wordsArray);
        //     //     $wordsIndex = $words->indexTheWords();  var_dump($words);echo '<br>';
        //     //     $word [$i+1]=$wordsIndex; 
        //     //     $singleWord=$wordsIndex ;
        //     // }
            
        // }   
        // $sura->Letters = $verseWordsObject; 

        //$verseJSON->VerseNumber = $verseIndex;
        $sura->verse = $verseObject;        
       // $sura->verseWords = $word;
        $jsonObject = json_encode($sura);
        echo $jsonObject;
